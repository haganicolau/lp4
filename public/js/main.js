 ...
 */
angular.module('biblioteca', ['minhasDiretrizes', 'ngAnimate', 'ngRoute'])
        .config(function ($routeProvider, $locationProvider) {

            /* ativa o módulo html5 que permite usar as urls mais limpas sem o # */
            /* caso este desativado para acessar as rotas deve se usar o #, por exemplo localhost:3000/#/livros e caso o navegador não tenha suporte para html5, ele volta a versão anterior automaticamente*/
            $locationProvider.html5Mode(true);

            /* a partir da rota /livros permite chamar o fragmento de DOM na pasta partials/principal.html e coloca este fragmento de DOM sobre a resposanbilidade do LivroController */
            $routeProvider.when('/livros', {
                templateUrl: 'partials/principal.html',
                controller: 'LivroController'
            });

            /* a partir da rota /livros/new permite chamar o framento de DOM na pasta partials/novo-livro.html e coloca este fragmento sobre responsabilidade do controller NovoLivroController */
